...
entity RISCV_AXI_v2_0_AXIF_M is
	generic (
	...
	port (
		...
		axi_base_address_i : in std_logic_vector(31 downto 0);
		--  WRITE CHANNEL
		axi_write_address_i : in std_logic_vector(31 downto 0);
		axi_write_init_i	: in std_logic;
		axi_write_data_i	: in std_logic_vector(31 downto 0);
		axi_write_next_o : out std_logic;
		axi_write_done_o : out std_logic;
		-- READ CHANNEL
		axi_read_address_i : in std_logic_vector(31 downto 0);
		axi_read_init_i	: in std_logic;
		axi_read_data_o	: out std_logic_vector(31 downto 0);
		axi_read_next_o : out std_logic;
		-- User ports ends
...
end RISCV_AXI_v2_0_AXIF_M;

architecture implementation of RISCV_AXI_v2_0_AXIF_M is
